...
export default async (req, res, next) => {
  try {
    ...
    if (vw.configuration.maxEmotes && processes.length >= vw.configuration.maxEmotes) {
      return next(new HttpError(null, {}, TOO_MANY_REQUESTS, 'Too many processes for today for this user.', 'tooManyUserProcesses'));
    }
