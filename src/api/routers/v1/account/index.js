...
router.put(
  "/virtual-worlds/:uuid/plan",
  validator(updatePlan),
  cognitoAuth,
  ownership,
  vwController.updatePlan,
);
...
// VW / ALIAS
router.get(
  "/virtual-worlds/:uuid/alias",
  validator(aliasGetAll),
  cognitoAuth,
  ownership,
  vwController.getAllAlias,
);
router.post(
  "/virtual-worlds/:uuid/alias",
  validator(aliasCreate),
  cognitoAuth,
  ownership,
  vwController.createAlias,
);
router.get(
  "/virtual-worlds/:uuid/alias/:aliasUuid",
  validator(aliasGet),
  cognitoAuth,
  ownership,
  vwController.getAlias,
);
router.put(
  "/virtual-worlds/:uuid/alias/:aliasUuid",
  validator(aliasUpdate),
  cognitoAuth,
  ownership,
  vwController.updateAlias,
);
router.delete(
  "/virtual-worlds/:uuid/alias/:aliasUuid",
  validator(aliasGet),
