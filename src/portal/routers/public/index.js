...
router.get("/env-config.js", (req, res) => {
  const hostname = 'local.kinetix.tech' //req.hostname
  ...
  res.send(`window._env_ = {
        ...
        REACT_APP_STORAGE_BASE_URL:"${req.protocol}://${hostname}:${PORT}",
        REACT_APP_ANIMATE_PROD_API_BASE_URL:"https://animate-api.kinetix.tech",
        REACT_APP_API_BASE_URL:"https://api.kinetix.tech",
        ...
        REACT_APP_AUTH_USER_POOL_WEB_CLIENT_ID:"4vlnjvh4c64gh9qsbio5eiggc5",
        REACT_APP_ENABLE_AVATAR_MANAGEMENT:"true",
        REACT_APP_ENABLE_BONE_MAPPING:"true",
        REACT_APP_ENABLE_ONBOARDING:"false",
        REACT_APP_SDK_PROD_API_BASE_URL:"${req.protocol}://${hostname}:${PORT}",
