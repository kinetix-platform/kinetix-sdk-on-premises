  ...
  [600],
  {
                ...
                d(
                  { id: "ConnectedLayout", className: "lg:flex" },
                  {
                    children: (0, a.jsx)(
                      ...
                      d(
                        {
                          contextItems: g.map(function (e) {
                            return { label: e.name, uuid: e.uuid };
                          }),
                          selectedContextItem: P,
                          onCreateContextItem:
                            g.length < A
                              ? function () {
                                  return I(!0);
                          ...
                          onSelectContextItem: function (e) {
                            var t;
                            (t = y.pathname.includes("/user-moderation")
                              ? s.n.USER_MODERATION.path
                              : s.n.VIRTUAL_WORLD.path),
                              f((0, o.Gn)(t, { uuid: e.uuid }));
                          },
                          topNavigationItems: p(
                            [],
                            g.length && P
                              ? p(
                                  p(
                          ...
                          children: (0, a.jsxs)(a.Fragment, {
                            children: [
                              (0, a.jsx)(
                                ...
                                (null == P ? void 0 : P.uuid) || "create",
                              ),
                              !m &&
                                (0, a.jsx)(l.FooterLight, {
                                  className: "w-fit mx-auto lg:w-full",
                                }),
                              (0, a.jsx)(l.CreateApplicationModal, {
                                isOpened: j,
                                onClose: function () {
                                  return I(!1);
                                },
    ...
    19600: (e, t, n) => {
      ...
      const c = function () {
        return (0, a.jsxs)("div", {
          children: [
            (0, a.jsx)(o.Title, { type: "h2", text: ["Games"] }),
            (0, a.jsx)(
              "p",
              u(
                { className: "mb-4" },
                {
                  children:
                    "Manage your Kinetix API access effortlessly. Retrieve your Game API Key and keep track of your usage and ensure seamless integration of our SDK with your system.",
                },
              ),
            ),
            (0, a.jsx)(
              ...
              u(
                ...
                {
                  children:
                    "To get started, we’ll provide you with a limited Game API key to use with Kinetix SDK or API endpoints. You will be able to create up to 40 users, 20 User Generated Emotes (UGE) and make up to 2000 Get API calls.",
                },
              ),
            ),
            (0, a.jsx)(
              ...
              u(
                ...
                {
                  children:
                    "Once you want to access the full capacity of our technology, upgrade your Game API key to unlimited to keep your integration running smoothly.",
                },
              ),
            ),
            (0, a.jsx)(
              ...
              u(
                ...
                {
                  children:
                    "You are able to request up to 5 Game API keys and select limited or unlimited plans for each depending on your needs.",
                },
              ),
            ),
            (0, a.jsx)("p", {
              children: (0, a.jsx)(
                ...
                u(
                  ...
                  { children: "Try out our REST API end points here" },
                ),
              ),
            }),
          ],
      ...
      const p = function () {
        ...
        return (0, a.jsxs)("div", {
          children: [
            (0, a.jsx)(o.Title, {
              type: "h3",
              text: ["Activate your", "Game API Key below"],
            }),
            (0, a.jsx)(
              "p",
              d(
            ...
            (0, a.jsx)(o.Button, {
              iconName: "add",
              label: "Request Game API key",
              onClick: function () {
                return n(!0);
              },
            }),
            (0, a.jsx)(o.CreateApplicationModal, {
              isOpened: t,
              onClose: function () {
                return n(!1);
              },
      ...
      const m = function () {
        return (0, a.jsxs)(
          ...
          h(
            {
              className:
                "px-6 py-4 mx-4 border-2 border-primary rounded-xl text-lg mb-6",
            },
            {
              children: [
                (0, a.jsx)(
                  "span",
                  h({ className: "text-primary mr-2" }, { children: "!" }),
                ),
                (0, a.jsx)("span", {
                  children:
                    "You must request an API key to access all our features like Avatar Management, Emote Library and others. Find the prompt to do the same, below on this page.",
                }),
              ],
            },
          ),
      ...
      const y = function () {
        var e = (0, i.s0)(),
          ...
          n = t.applications,
          s = (t.limit, t.defaultApplicationUrl);
        return (
