                      ...
                      d(
                        {
                          ...
                          onSelectContextItem: function (e) {
                            var t;
                            (t = b.pathname.includes("/user-moderation")
                              ? u.n.USER_MODERATION.path
                              : u.n.VIRTUAL_WORLD.path),
                              m((0, l.Gn)(t, { uuid: e.uuid }));
                          },
                          topNavigationItems: h(
                            [],
                            T.length && U
                              ? h(
                                  h(
                                    h(
                                      ...
                                      [
                                        ...
                                        },
                                        {
                                          ...
                                          iconName: "neurology",
                                          to: (0, l.Gn)(
                                            u.n.USER_GENERATED_EMOTES.path,
                                            { uuid: U.uuid },
                                          ),
                                        },
                                      ],
                                  ...
                                  [
                                    {
                                      ...
                                      iconName: "mood",
                                      to: (0, l.Gn)(u.n.EMOTES_ICON.path, {
                                        uuid: U.uuid,
                                      }),
                                    },
                                  ],
                              ...
                              : [
                                  {
                                    label: "Game API Key",
                                    iconName: "public",
                                    to: u.n.CREATE_VIRTUAL_WORLD.path,
                                  },
                                ],
                            !0,
                          ),
                        ...
                        },
                        {
                          children: (0, r.jsxs)(r.Fragment, {
                            children: [
                              ...
                              !p &&
                                (0, r.jsx)(o.FooterLight, {
                                  className: "w-fit mx-auto lg:w-full",
                                }),
                              (0, r.jsx)(o.CreateApplicationModal, {
                                isOpened: j,
                                onClose: function () {
                                  return E(!1);
                                },
                  ...
                  switch (r.label) {
                    case 0:
                      return (
                        r.trys.push([0, , 2, 3]),
                        b(!0),
                        [4, (0, u.IB)({ virtualWorldUuid: t, nextPage: n })]
                      );
                    case 1:
                      return (
                        (e = r.sent()),
                ...
                switch (r.label) {
                  ...
                  case 1:
                    return (
                      ...
                      T(
                        v.filter(function (t) {
                          return t.emoteUuid !== e.emoteUuid;
                        }),
                      ),
                      t
                        ? (o.toast.success("Your emote has been validated."),
                          [4, (0, u.Jc)(O, e.user, e.emoteUuid)])
                        : [3, 3]
                    );
                  case 2:
                    return r.sent(), [3, 5];
                  case 3:
                    return (
                      o.toast.success("Your emote has been unpublished."),
                      [4, (0, u.Xn)(O, e.user, e.emoteUuid)]
                    );
                  case 4:
                    r.sent(), (r.label = 5);
                  case 5:
          ...
          (0, r.jsx)(c.Z, {
            children: (0, r.jsxs)(r.Fragment, {
              children: [
                ...
                (0, r.jsx)(o.Title, { type: "h3", text: ["Overview"] }),
                null === y
                  ? (0, r.jsx)(
                      "div",
                      d(
                        { className: "flex justify-center py-10" },
                        { children: (0, r.jsx)(o.Loader, {}) },
                      ),
                    )
                  : (0, r.jsx)(r.Fragment, {
                      children: y
                        ? (0, r.jsxs)("div", {
                            children: [
                                    ...
                                    children: [
                                      (0, r.jsx)(
                                        ...
                                        d(
                                          {
                                            className:
                                              "material-symbols-rounded text-3xl text-error-60",
                                          },
                                          { children: "error" },
                                        ),
                                      ),
                                      (0, r.jsx)("span", {
                                        children:
                                          "Our system detected that the following emotes might be inappropriate. Please review.",
                                      }),
                                    ],
                                  },
                                ),
                              ...
                              (0, r.jsxs)(o.Table, {
                                children: [
                                  (0, r.jsx)(o.Table.Thead, {
                                    children: (0, r.jsxs)(o.Table.Tr, {
                                      children: [
                                        (0, r.jsx)(o.Table.TdHead, {
                                          label: ["Emote name"],
                                        }),
                                        (0, r.jsx)(o.Table.TdHead, {
                                          label: ["Emote preview"],
                                            ...
                                            (0, r.jsx)(o.Table.Td, {
                                              children: (0, r.jsx)(
                                                ...
                                                d(
                                                  {
                                                    className:
                                                      "underline hover:text-primary duration-300 transition-all cursor-pointer",
                                                    onClick: function () {
                                                      return t(
                                                        (0, l.Gn)(
                                                          s.n.USER_MODERATION
                                ...
                                children: [
                                  (0, r.jsx)(
                                    ...
                                    d(
                                      {
                                        className:
                                          "material-symbols-rounded text-3xl text-green",
                                      },
                                      { children: "check_circle" },
                                    ),
                                  ),
                                  (0, r.jsx)("span", {
                                    children: "You have no emotes to review.",
                                  }),
                                ],
                              },
                            ),
