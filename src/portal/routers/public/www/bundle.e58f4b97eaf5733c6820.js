                ...
                d(
                  { id: "ConnectedLayout", className: "lg:flex" },
                  {
                    children: (0, a.jsx)(
                      ...
                      d(
                        {
                          contextItems: v.map(function (e) {
                            return { label: e.name, uuid: e.uuid };
                          }),
                          selectedContextItem: I,
                          onCreateContextItem:
                            v.length < j
                              ? function () {
                                  return w(!0);
                                  ...
                                  [
                                    {
                                      ...
                                      iconName: "mood",
                                      to: (0, l.Gn)(s.n.EMOTES_ICON.path, {
                                        uuid: I.uuid,
                                      }),
                                    },
                                  ],
                          ...
                          children: (0, a.jsxs)(a.Fragment, {
                            children: [
                              (0, a.jsx)(
                                ...
                                (null == I ? void 0 : I.uuid) || "create",
                              ),
                              !p &&
                                (0, a.jsx)(o.FooterLight, {
              ...
              ? (0, a.jsx)(a.Fragment, {
                  children: (0, a.jsxs)("div", {
                    children: [
                      (0, a.jsx)(o.Title, {
                        type: "h2",
                        text: ["Virtual World", "Settings"],
                      }),
                      (0, a.jsx)("p", {
                        children:
                          "Here, you can manage your virtual world settings.",
                      }),
                      (0, a.jsxs)(
                        "form",
                        c(
                          {
                            onSubmit: g(function (e) {
                              return (
                                ...
                                new ((a = void 0) || (a = Promise))(function (
                                  e,
                                  i,
                                ) {
                                  function l(e) {
                            ...
                            children: [
                              (0, a.jsxs)(
                                ...
                                c(
                                  {
                                    className:
                                      "p-6 bg-surface-30 rounded-xl mt-6 max-w-4xl",
                                  },
                                  {
                                    children: [
                                      (0, a.jsx)(
                                      ...
                                      (0, a.jsxs)(
                                        ...
                                        c(
                                          {
                                            className:
                                              "relative transition-all duration-300 max-h-max delay-300",
                                          },
                                          {
                                            children: [
                                              (0, a.jsx)(o.Fieldset, {
                                        ...
                                        c(
                                          ...
                                          },
                                          {
                                            children: (0, a.jsx)("span", {
                                              children:
                                                "Be careful when editing these settings. Disabled formats will not be generated and animations will not be available.",
                                            }),
                                          },
                                        ),
                                      ),
                                                ...
                                                children: [
                                                  ...
                                                  (0, a.jsx)(
                                                    ...
                                                    c(
                                                      {
                                                        title:
                                                          "Generate the animation in the GLB & Kinanim formats. Use this if you want to use our unity or unreal engine SDK.",
                                                      },
                                                      {
                                                        children: function (e) {
                                                          return (0, a.jsx)(
                              ...
                              (0, a.jsx)(
                                ...
                                c(
                                  {
                                    className:
                                      "flex justify-end max-w-4xl mt-6",
                                  },
                                  {
